...
namespace Project2EmailNight.Controllers
{
    public class EmailController : Controller
    {
        ...
        public IActionResult SendEmail(MailRequestDto mailRequestDto)
        {
            ...
            MailboxAddress mailboxAddressFrom = new MailboxAddress("Identity Admin", "orcunozsen12@gmail.com");
            ...
            smtpClient.Authenticate("orcunozsen12@gmail.com", "ekfm edkf ngfm onxw");
